...
import Logo from "./../../image/white_on_trans1.png"
...
const navigation = [
  ...
  { name: 'Certificate', href: '/certicate', current: false },
]
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <img
                    alt=""
                    src="https://static.vecteezy.com/system/resources/previews/008/302/516/original/eps10-green-user-icon-or-logo-in-simple-flat-trendy-modern-style-isolated-on-white-background-free-vector.jpg"
